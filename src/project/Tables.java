...
public class Tables {
    public static void main(String[] args) {
        ...
        try{
            ...
            st.executeUpdate("create table room(RoomNo varchar(10),RoomType varchar(200),Bed varchar(100),Price int,Status varchar(20))");
            st.executeUpdate("create table customer(id int,name varchar(100),mobileNumber varchar(20),nationality varchar(200),gender varchar(100),email varchar(200),idProof varchar(200),address varchar(500),checkIn varchar(50),roomNo varchar(20),bed varchar(100),roomType varchar(100),pricePerDay int,numberOfDayStay int,totalAmount varchar(200),checkOut varchar(50))");
